...
// Bibliotecas novas para lidar com audio
...
int main()
{
    ...
    // Inicializamos as configs de audio
    must_init(al_install_audio(), "audio");
    must_init(al_init_acodec_addon(), "audio codecs");
    must_init(al_reserve_samples(16), "reserve samples");

    // Setando o som de elefante
    ...
    // Destroy Sample para destruir o som de elefante que foi criado.
    al_destroy_sample(elephant);
    // Destroy Audio para destruir musica criada.
